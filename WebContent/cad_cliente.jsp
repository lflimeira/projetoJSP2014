	...
	<div style="margin: auto; width: 940px; height: 350px; display: table;">
		...
		<fieldset style="border: 1px;border-radius: 10px;border-style: solid; width: 400px; min-height: 150px; margin: auto; margin-top: 100px;">
			...
			%>
				<table>
					<tr>					
						<td style='text-align: center;' colspan="3"><%=bundle.getString("tela.cadDCliente.cliente")%><%= contCli%></td>
					</tr>
					<tr>					
						...
						<td>
							<select id="tipo" name="tipo<%= i%>"> 
								<option value="Adulto"><%=bundle.getString("tela.cadDCliente.adulto")%></option> 
							</select>
						</td>
					</tr>
					<tr>					
					...
					<tr>					
						...
						<td>
							<select id="tipo" name="tipo_cri<%= i%>"> 
								<option value="Criança"><%=bundle.getString("tela.cadDCliente.crianca")%></option> 
							</select>
						</td>
					</tr>
					<tr>					
