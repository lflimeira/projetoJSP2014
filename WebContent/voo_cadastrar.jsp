		...
		<fieldset style="border: 1px;border-radius: 10px;border-style: solid; width: 400px; min-height: 150px; margin: auto; margin-top: 100px;">
			<legend style="color: red;">Cadastro de Voos</legend>
				...
				<table>
					...
					<tr>					
						<h4>Estou Tendo Dificuldade em preencher o combobox de aeronave com a lista de aeronaves cadastradas, BY:Jefferson 19/10 - 06:02 sono!!</h4>						
...
<%-- 							  <option><%= aeronaveTO.getNomeAeronave() %></option> --%>
